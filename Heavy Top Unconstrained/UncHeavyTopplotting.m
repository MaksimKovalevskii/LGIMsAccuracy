...
file_patterns = {'UncHT_ClassicEP_dt_%.2fms.mat', 'UncHT_NE_EP_dt_%.2fms.mat', ...
                'UncHT_CartNE_dt_%.2fms.mat', 'UncHT_CartLGIM_dt_%.2fms.mat', 'UncHT_EPLGIM_dt_%.2fms.mat'};
% method_names = {'Conv-Quat', 'NE-Quat','Quat-LGIM'};
% file_patterns = {'UncHT_ClassicEP_dt_%.2fms.mat', 'UncHT_NE_EP_dt_%.2fms.mat', ...
%                  'UncHT_EPLGIM_dt_%.2fms.mat'};

% Load reference data 
reference_data = load('UncHTRef.mat');
