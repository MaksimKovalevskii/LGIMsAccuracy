...
% figure;
% 
% plot(t, theta, 'b-', 'LineWidth', 2.5); 
% ylim([-0.5, 3.5]);
% xlabel('Time (s)', 'Interpreter', 'latex', 'FontSize', 11);
% ylabel('$\theta(t)$ (rad)', 'Interpreter', 'latex', 'FontSize', 11);
% grid on;
% set(gca, 'FontSize', 10);
% 
% % Add horizontal line at pi to show singularity
% hold on;
% yline(pi, 'r--', 'LineWidth', 1.5);
% legend('$\theta(t) = \|\mathbf{\psi}(t)\|$', '$\theta = \pi$ (singularity)', ...
